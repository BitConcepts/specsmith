...
correct answer and \$0.1299 mean estimated cost, but every row required a CSS
repair and one invoked loop recovery. The audit therefore blocked a ten-row
release sample. This adds fresh-fixture evidence while preserving the negative
conclusion on release reliability and real-repository generalization.
