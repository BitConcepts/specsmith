...
|----------|------:|--------:|--------:|-----------:|------:|--------:|--------:|-----------:|
| Raw agent (ungoverned)| 77%| 53.1k| $0.19184| $64.71| 92%| 30.3k| $0.16914| $68.22|
| CLAUDE.md / AGENTS.md| —| —| —| —| —| —| —| —|
| Cursor .cursor/rules| —| —| —| —| —| —| —| —|
| GitHub Copilot instructions| —| —| —| —| —| —| —| —|
| OpenAI Codex CLI AGENTS.md| —| —| —| —| —| —| —| —|
...
| Agile BDD / TDD| —| —| —| —| —| —| —| —|
| specsmith LIGHT (preflight)| —| —| —| —| —| —| —| —|
| specsmith FULL (governed)| **100%**| **15.6k**| **$0.08033**| **$35.35**| **100%**| **10.8k**| **$0.10021**| **$44.09**|
...
|---|---:|---:|---:|---|---:|---:|---:|---|
| gpt-5.6-terra + FULL | 100% | 15.6k | $0.08033 | gpt-5.6-sol + UNGOVERNED | 92% | 30.3k | $0.16914 | Matches/exceeds correctness with lower TPCA |

**Paired inference — gpt-5.6-terra + FULL vs gpt-5.6-sol + UNGOVERNED:**

- Fixed-suite 95% CI: correctness difference -5.7 to +26.1 percentage points; TPCA ratio 0.437–0.608.
- Task-cluster 95% CI: correctness difference -6.0 to +31.8 percentage points; TPCA ratio 0.328–0.870.
